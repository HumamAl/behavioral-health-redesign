...
export const APP_CONFIG = {
  appName: "Mindwell Behavioral Health",     // Display name (sidebar header, page title)
  projectName: "Mindwell Redesign",          // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,         // Client first name, or null — never render "null"
  domain: "healthcare",                      // Domain (finance, health, marketplace, tech, etc.)
  aesthetic: "nature-wellness" as AestheticProfile,  // Drives data-theme="..." on <html>
  demoFormat: "multi-screen-walkthrough" as DemoFormat,   // Layout architecture for Tab 1
  deviceModel: "chrome-browser" as DeviceModel,           // Device frame model (frame formats only)
